...
const Navbar = () => {
    ...
    return (
        <nav>
            ...
            <ul className={`md:flex justify-end gap-12 absolute md:static duration-500 bg-gray-500 rounded-lg md:rounded-none p-3 lg:pr-24 font-bold text-white ${open ? 'top-6' : '-top-48'}`}>
                {
